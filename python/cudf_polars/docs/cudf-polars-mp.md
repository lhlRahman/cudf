...
`RayEngine` is imported from `cudf_polars.streaming.frontend.ray`. On construction it:
...
`DaskEngine` is imported from `cudf_polars.streaming.frontend.dask`. On construction it:
...
manager imported from `cudf_polars.streaming.frontend.spmd`. On construction it:
