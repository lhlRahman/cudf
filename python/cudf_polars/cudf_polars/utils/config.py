...
class SPMDContext:
    ...
    .. note::
        ...
        :class:`~cudf_polars.engine.spmd.SPMDEngine`, so
...
class RayContext:
    ...
    .. note::
        ...
        :func:`~cudf_polars.engine.ray.evaluate_pipeline_ray_mode`
        by :class:`~cudf_polars.engine.ray.RayEngine`.
        Do not persist or transfer this object across Ray sessions.

    Parameters
    ----------
    rank_actors
        List of :class:`~cudf_polars.engine.ray.RankActor`
